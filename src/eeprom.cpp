...
void eeprom_default_sheet_name(uint8_t index, SheetName &sheetName)
{
    ...
    if (index < 2) strcpy_P(sheetName.c, PSTR("Smooth"));
    else if (index < 4) strcpy_P(sheetName.c, PSTR("Textur"));
    else strcpy_P(sheetName.c, PSTR("Custom"));

    switch (index)
    {
    case 0: sheetName.c[6] = '1'; break;
    case 1: sheetName.c[6] = '2'; break;
    case 2: sheetName.c[6] = '1'; break;
    case 3: sheetName.c[6] = '2'; break;
    case 4: sheetName.c[6] = '1'; break;
    case 5: sheetName.c[6] = '2'; break;
    case 6: sheetName.c[6] = '3'; break;
    case 7: sheetName.c[6] = '4'; break;
    default: break;
    }
